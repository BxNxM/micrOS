...
function embedWidget(container, command, params={}) {
    const { title_len = 1, callback = '', image = false, retry = 3000, title = null } = params;
    ...
    content.addEventListener('load', clearRetry);
    ...
    container.addEventListener('DOMNodeRemovedFromDocument', clearRetry);
