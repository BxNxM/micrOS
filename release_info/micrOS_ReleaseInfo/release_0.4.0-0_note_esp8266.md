...
| :------:  | :-------------------: | :---------: | :-----------: |
| 0.4.0-0   | **~25,9%** 2512 byte  |   esp8266   |     [default_profile](https://github.com/BxNxM/MicrOS/blob/master/release_info/node_config_profiles/default_profile-node_config.json)      |
...
|  version  |       memory usage    | board type  |     config    | 
| :------:  | :-------------------: | :---------: | :-----------: |
| 0.4.0-0   | **~52,8%**  5072 byte |   esp8266     |     [heartbeat_profile](https://github.com/BxNxM/MicrOS/blob/master/release_info/node_config_profiles/heartbeat_profile-node_config.json)      |
...
|  version  |       memory usage    | board type  |     config    | 
| :------:  | :-------------------: | :---------: | :-----------: |
| 0.4.0-0   | **~67,9%**  8336 byte |    esp8266    |     [neopixel_profile](https://github.com/BxNxM/MicrOS/blob/master/release_info/node_config_profiles/neopixel_profile-node_config.json)      |
