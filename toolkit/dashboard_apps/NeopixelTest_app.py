...
def evaluate_test_data(answer_msg, red, green, blue, test_cycle=None):
    expectation_in_data = 'NEOPIXEL SET TO'
    TestData.EXEC_CNT += 1
    if f'"R": {red}' in answer_msg and f'"G": {green}' in answer_msg and f'"B": {blue}' in answer_msg:
...
def app(test_cycle=32, devfid=None):
    ...
    for _ in range(0, test_cycle):
        ...
        command = base_cmd() + ['neopixel', 'neopixel {} {} {} >json'.format(red, green, blue)]
