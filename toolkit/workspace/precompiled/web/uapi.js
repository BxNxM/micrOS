let BASE_URL='';function initializeBaseURL(){if(!BASE_URL&&typeof window!=='undefined'){BASE_URL=`http://${window.location.hostname}${window.location.port ? `:${window.location.port}` : ""}`;}}
