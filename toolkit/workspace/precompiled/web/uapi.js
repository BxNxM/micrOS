...
function restConsole(apiUrl,data,delta,root=document){const urlEl=root.url||byId('restConsoleUrl',root);const responseEl=root.response||byId('restConsoleResponse',root);const timeEl=root.time||byId('restConsoleTime',root);if(!urlEl||!responseEl||!timeEl){return;}
